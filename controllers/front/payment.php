...
class UcppaymentModuleFrontController extends ModuleFrontController
{
    ...
    private function handleGet($headers, $log_data)
    {
        return [
            ...
            'capabilities' => [
                'payment_methods' => ['card', 'alipay', 'apple_pay'],
                'supported_currencies' => ['EUR', 'USD', 'GBP'],
                'webhook_url' => 'https://www.passioncampagne9.projets-omega.net/payment/stripe/webhook'
            ]
        ];
    }
    ...
    private function getJsonInput()
    {
        ...
        if (empty($input)) {
            throw new Exception('Empty request body. Payment endpoints accept JSON data for processing.');
        }
